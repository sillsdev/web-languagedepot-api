    ...
    Navbar.navbar [ Navbar.Color IsInfo ]
        [ Container.container [ ]
            [ Navbar.Brand.div [ ]
              ...
              Navbar.menu [ ]
                  [ Navbar.Start.div [ ]
                      [ Navbar.Item.a [ Navbar.Item.Props [ Href "#projects" ] ]
                            [ str "Projects" ]
                        Navbar.Item.a [ Navbar.Item.Props [ Href "#users" ] ]
                            [ str "Users" ] ] ]
...
let menu =
    Menu.menu [ ]
        [ Menu.label [ ]
              [ str "General" ]
          Menu.list [ ]
              [ Menu.Item.a [ Menu.Item.Props [ Href "#projects" ] ]
                    [ str "Projects" ]
                Menu.Item.a [ Menu.Item.Props [ Href "#users" ] ]
                    [ str "Users" ] ]
          Menu.label [ ]
              [ str "Administration" ]
          Menu.list [ ]
